...
const Navbar = () => {
  ...
  return (
    ...
    <div id='navBar' className="w-full h-24 sticky top-0 z-50 bg-bodyColor mx-auto flex justify-between items-center
     font-titleFont border-b-[2px] border-b-gray-600">
        ...
        <div >
            <ul className='hidden mdl:inline-flex items-center gap-6 lg:gap-12  '>
                ...
                <a href="https://drive.google.com/file/d/1TJ6iNndNSb6wf6r8YeHHgYAfmqNKUEZk/view?usp=drive_link" target="_blank">Resume</a></button>
            </ul>
            ...
            show && (
                ...
                <div className='w-[80%] h-auto overflow-scroll rounded-xl m-auto absolute top-0 left-0 bg-gray-900 p-4 scrollbar-hide'>
                    ...
                    <div className='flex flex-col gap-8 py-2 relative'>
                        ...
                        <div className=' '>
                            <img className='w-20 shadow-inner shadow-cyan-300 rounded-full' src={logo} alt="logo" />
                            <p className='text-lg text-designColor mt-4'>
                                Quick Links
                            </p>
                        </div>
                    ...
                    <a href="https://example.com" className=' text-base font-normal text-gray-400 tracking-wide cursor-pointer hover:text-designColor duration-300' target="_blank">Resume</a>
